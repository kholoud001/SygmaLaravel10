...
<div class="p-4 md:ml-52  flex gap-2 flex-col">
    ...
    <form id="all" method="POST" action="{{ route('all.store') }}" enctype="multipart/form-data">
        ...
        <div class="w-6/12 mx-auto border border-gray-300 p-4 rounded-lg">
            ...
            <!-- Max Year -->
            <label for="max_year"
                class="block mt-4 mb-2 text-sm font-medium text-gray-900 dark:text-white">Entrez Max
                année</label>
            <div class="relative">
                ...
                <input type="text" id="max_year" name="max_year"
                    ...
                    placeholder="MAX ANNEE ....">
            </div>

            <!-- Min Year -->
            <label for="min_year"
                class="block mt-4 mb-2 text-sm font-medium text-gray-900 dark:text-white">Entrez Min
                année</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
