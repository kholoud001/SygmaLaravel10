                                    ...
                                    <svg class="m-auto w-11/12 md:w-full relative bottom-12" viewBox="200 -400 1500 1800"
                                        ...
                                        <g id="layer2" transform="matrix(0, 1, -1, 0, 254.000085527972, -254.000194186645)"
                                            ...
                                            <path class="mapPath"
                                                ...
                                                style="stroke: rgb(0, 0, 0); stroke-width: 5; fill:  {{ isset($colors[$dossier->id][19]) ? 'rgb(' . $colors[$dossier->id][19] . ')' : 'rgb(255, 255, 255)' }};"
                                            ...
                                            <g id="g4451" transform="translate(-13.78 15.524)">
                                                <path class="mapPath"
                                                    ...
                                                    style="stroke:#000000;stroke-width:5;fill:{{ isset($colors[$dossier->id][19]) ? 'rgb(' . $colors[$dossier->id][19] . ')' : 'rgb(255, 255, 255)' }};"
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill:  {{ isset($colors[$dossier->id][5]) ? 'rgb(' . $colors[$dossier->id][5] . ')' : 'rgb(255, 255, 255)' }};"
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: {{ isset($colors[$dossier->id][16]) ? 'rgb(' . $colors[$dossier->id][16] . ')' : 'rgb(255, 255, 255)' }};"
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: {{ isset($colors[$dossier->id][15]) ? 'rgb(' . $colors[$dossier->id][15] . ')' : 'rgb(255, 255, 255)' }};"
                                            ...
                                            <path class="mapPath"
                                                ...
                                                style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: {{ isset($colors[$dossier->id][2]) ? 'rgb(' . $colors[$dossier->id][2] . ')' : 'rgb(255, 255, 255)' }};"
                                            ...
                                            <g id="g4428" transform="translate(-13.78 15.524)">
                                                <path class="mapPath"
                                                    ...
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5px; fill:  {{ isset($colors[$dossier->id][7]) ? 'rgb(' . $colors[$dossier->id][7] . ')' : 'rgb(255, 255, 255)' }};"
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5px; fill: {{ isset($colors[$dossier->id][13]) ? 'rgb(' . $colors[$dossier->id][13] . ')' : 'rgb(255, 255, 255)' }};"
                                                    data-name="Aile arriere droit" data-severity="0">
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill:  {{ isset($colors[$dossier->id][9]) ? 'rgb(' . $colors[$dossier->id][9] . ')' : 'rgb(255, 255, 255)' }};"
                                                ...
                                                <path class="mapPath"
                                                    ...
                                                    style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: {{ isset($colors[$dossier->id][11]) ? 'rgb(' . $colors[$dossier->id][11] . ')' : 'rgb(255, 255, 255)' }};"
                                            ...
                                            <path class="mapPath"
                                                ...
                                                style="stroke: rgb(0, 0, 0); stroke-width: 5px; paint-order: stroke; fill: {{ isset($colors[$dossier->id][4]) ? 'rgb(' . $colors[$dossier->id][4] . ')' : 'rgb(255, 255, 255)' }};"
                                            ...
                                            <path class="mapPath"
                                                ...
                                                style="stroke-width: 5px; stroke: rgb(0, 0, 0); paint-order: stroke; fill: {{ isset($colors[$dossier->id][3]) ? 'rgb(' . $colors[$dossier->id][3] . ')' : 'rgb(255, 255, 255)' }};"
                                            ...
                                            <path class="mapPath"
                                                ...
                                                style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: {{ isset($colors[$dossier->id][17]) ? 'rgb(' . $colors[$dossier->id][17] . ')' : 'rgb(255, 255, 255)' }};"
                                            ...
                                            <path class="mapPath"
                                                ...
                                                style="stroke: rgb(0, 0, 0); stroke-width: 5; fill: {{ isset($colors[$dossier->id][18]) ? 'rgb(' . $colors[$dossier->id][18] . ')' : 'rgb(255, 255, 255)' }};"
                                            ...
                                            <path class="mapPath"
                                                ...
                                                style="stroke-width: 5px; stroke: rgb(0, 0, 0); paint-order: stroke; fill: {{ isset($colors[$dossier->id][1]) ? 'rgb(' . $colors[$dossier->id][1] . ')' : 'rgb(255, 255, 255)' }};"
                                            ...
                                            <path class="mapPath"
                                                ...
                                                style="stroke-width: 5px; stroke: rgb(0, 0, 0); paint-order: stroke; fill: {{ isset($colors[$dossier->id][20]) ? 'rgb(' . $colors[$dossier->id][20] . ')' : 'rgb(255, 255, 255)' }};"
